...
export const en = {
  ...
  "checkout.pickupNearYou": "Nearest first.",
  "checkout.pickupNoDistance": "Both counters, whichever suits you.",
  "checkout.findingYou": "Finding you…",
  "checkout.milesAway": "{miles} mi away",
  "checkout.opensAt": "Opens at {time}",
  "checkout.notMadeHere": "Not made here: {items}",

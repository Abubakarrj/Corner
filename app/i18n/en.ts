...
export const en = {
  ...
  "gift.balanceLede": "Enter the card number and we'll tell you what's left on it.",
  ...
  "gift.spendItAnywhere": "Give the number at the counter, or enter it at checkout.",
  "gift.balanceSpent": "This card has been spent.",
  "gift.balancePrivacy": "We don't store your card number. Treat it like cash: anyone who has it can spend it.",
  "gift.cardNotFound": "We couldn't find that card. Check the number and try again.",
  "gift.balanceUnavailable": "We can't check balances right now. Ask at the counter.",
  "gift.checkYours": "Check a balance",

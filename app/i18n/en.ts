...
export const en = {
  ...
  "common.undo": "Undo",
  "cart.removedOne": "{name} removed.",
  "cart.undoRemoveOf": "Put {name} back in the basket",
  ...
  "checkout.validPhone": "Enter a phone number we can reach you on.",
  "api.fillNamePhone": "Fill in your name and phone number.",
  ...
  "api.soldOutNow": "Some items sold out.",
  "checkout.soldOutRemoved": "We took {names} out",
  "checkout.soldOutRemovedBody": "They sold out while your order was open. Everything else is still here — check it over and place it again.",
  ...
  "notes.neighborhoodPlaceholder": "echo park, k-town, anywhere",
  "notes.yourNote": "Your note",
  "notes.notePlaceholder": "say hi...",
  "notes.next": "Next",
  "notes.cancel": "Cancel",
  "notes.drawBlurb": "Draw us something, or take a picture. Skip both if you'd rather.",
  "notes.padLabel": "A pad to draw on with your finger",
  "notes.padHint": "draw here",
  "notes.padFull": "That's a full page. Undo a line to keep going.",
  "notes.undoStroke": "Undo",
  "notes.clearPad": "Clear",
  "notes.inkLabel": "Pencil colour",
  "notes.inkBlack": "Black",
  "notes.inkRed": "Red",
  "notes.inkAmber": "Amber",
  "notes.inkGreen": "Green",
  "notes.inkBlue": "Blue",
  "notes.inkViolet": "Violet",
  "notes.inkPink": "Pink",
  "notes.penLabel": "Pencil size",
  "notes.penThin": "Thin",
  "notes.penMedium": "Medium",
  "notes.penThick": "Thick",
  "notes.redoStroke": "Redo",
  ...
  "notes.addPhoto": "Take a photo",
  "notes.retakePhoto": "Retake",
  "notes.removePhoto": "Remove",
  "notes.photoBusy": "Getting it ready...",
  "notes.photoWait": "Photos go up once we've had a look. Usually a few seconds.",
  "notes.developing": "developing",
  "notes.unpin": "Unpin",
  "notes.unpinAsk": "Take it down?",
  ...
  "checkout.chargedOnPlace": "Charged when you place the order.",
  "checkout.paymentsOff": "Card payments are off. Call {phone} to order.",
  "checkout.dueNow": "Left to pay",
  "checkout.giftCardNumber": "Gift card number",
  "checkout.giftApply": "Apply",
  "checkout.giftApplied": "Gift card: −{amount}",
  "checkout.giftCoversAll": "That covers the whole order. Nothing left to pay.",
  "checkout.giftLeavesDue": "{amount} left to pay.",
  ...
  "checkout.orderForLater": "Order for later",
  "checkout.scheduleLead": "We're closed now. Choose a pickup time and we'll have it ready then.",
  "checkout.pickupTime": "Pickup time",
  "checkout.findingTime": "Finding a time…",
  "checkout.pickupAt": "Pickup {time}",
  "checkout.heldForYou": "Held for you",
  "checkout.scheduleMoved": "That time just went. The next one we can do is {time}.",
  "checkout.readyAtScheduled": "We'll have it ready {time}.",
  "api.scheduleFull": "Every pickup time is taken until tomorrow.",
  "api.scheduleUnavailable": "We can't schedule pickups right now. Try again in a few minutes.",
  "api.scheduleChanged": "That pickup time just went.",
  ...
  "checkout.cardChargedDone": "Your card was charged when you placed this order.",
  ...
  "rewards.keepBody": "They don’t expire, and they follow your account to any phone you sign in on.",
  "rewards.counterTitle": "A member code of your own",
  "rewards.counterBody": "Sixteen characters, easy to read out, with a QR code on the same screen.",
  "rewards.join": "Join Corner Rewards",
  "rewards.joining": "Joining…",
  "rewards.freeNote": "Free to join. No card number, no monthly fee.",
  "rewards.balance": "Your points",
  "rewards.codeLabel": "Your member code, as a QR code",
  "rewards.notYetAtCounter": "The counter can’t scan this yet. Your points are adding up on every order in the meantime.",
  "rewards.rowValue": "Points and your code",
  "pin.title": "Drop a pin",
  "pin.lead": "Move the map so the pin sits on your door. This is where the courier goes.",
  ...
  "pin.searchLabel": "Search for an address",
  "pin.searchPlaceholder": "Search an address, or move the map",
  "pin.nearbyPlaces": "Addresses at this pin",
  "pin.instructions": "For the courier",
  "pin.instructionsPlaceholder": "Entrance on Ardmore, gate code…",
  "pin.needsAnAddress": "No address here. Move the pin to a building or a street.",
  "pin.mapUnavailable": "The map didn’t load, so we’ll use this address as it is.",
  "delivery.noPinYet": "No map pin — we’ll look this address up.",
  ...
  "account.liveChat": "Ask Riley",
  "account.feedback": "Feedback",
  "account.settings": "Settings",
  "account.ordersCount": "{count} so far",
  "account.allOrders": "Every order",
  "account.nothingYet": "Nothing here yet",
  ...
  "api.paymentsOff": "Card payments are off right now, so we can't take this order. Please call the shop.",
  ...
  "gift.balanceTitle": "Gift card balance",
  "gift.cardNumber": "Card number",
  "gift.cardNumberHint": "7783 3200 0000 0000",
  "gift.checkBalance": "Check balance",
  "gift.checking": "Checking…",
  "gift.balanceOnCard": "On this card",
  "gift.spendItAnywhere": "Use it at the counter or at checkout.",
  "gift.balanceSpent": "This card is empty.",
  "gift.balancePrivacy": "We don't store it. Treat it like cash.",
  "gift.cardNotFound": "Card not found. Check the number.",
  "gift.balanceUnavailable": "Can't check balances right now. Ask at the counter.",
  ...
  "careers.jdCounterDo2": "Run the register, handle cash and cards, and close out your own drawer",
  "careers.jdCounterDo3": "Keep the front stocked, wiped down and looking open",
  "careers.jdCounterDo4": "Answer the phone, and the questions that come with a menu people care about",
  "careers.jdCounterWant1": "Steady with a line out the door, and a calm way of working through it",
  "careers.jdCounterWant2": "Careful with an order. Allergies and substitutions are the ones that matter",
  "careers.jdCounterWant3": "Reliable on a schedule, weekends included",
  "careers.jdKitchenSummary": "Spreads, sandwiches, and keeping the line stocked so the morning never runs out of anything.",
  "careers.jdKitchenDo1": "Mix the schmears and prep the fillings to the recipes",
  "careers.jdKitchenDo2": "Build sandwiches to order, through the rush",
  "careers.jdKitchenDo3": "Keep the line stocked, labelled and rotated",
  "careers.jdKitchenDo4": "Break down, wash down, and set up for tomorrow",
  "careers.jdKitchenWant1": "Steady hands at speed. A rush is the job, not the exception",
  "careers.jdKitchenWant2": "Clean as you go, and straight about dates and labels",
  "careers.jdKitchenWant3": "Comfortable on your feet for a full shift",
  "careers.jdLeadSummary": "Run the shift. Open or close, keep the floor moving, and make the calls that can't wait for a manager.",
  "careers.jdLeadDo1": "Open or close the shop, including the count and the deposit",
  "careers.jdLeadDo2": "Set the floor for the shift and move people to where the line is",
  "careers.jdLeadDo3": "Handle the situations a customer shouldn't have to ask twice about",
  "careers.jdLeadDo4": "Train new people on the counter and the register, and watch the bake for what's running short",
  "careers.jdLeadWant1": "Have run a shift before, in food or in retail",
  "careers.jdLeadWant2": "Decide rather than wait, and say afterwards what happened",
  "careers.jdLeadWant3": "Available for the whole shift, opening or closing",
  "careers.jdManagerSummary": "Ordering, the schedule, hiring, and how the whole shop runs day to day.",
  "careers.jdManagerDo1": "Build the schedule and keep it staffed",
  "careers.jdManagerDo2": "Order product, and hold the vendors and the counts",
  "careers.jdManagerDo3": "Hire, train, and keep the standard on the floor",
  "careers.jdManagerDo4": "Own food safety, the logs, and the health inspection",
  "careers.jdManagerDo5": "Watch labour and cost of goods against the week",
  "careers.jdManagerWant1": "Have managed a food business, or been second in one",
  ...
  "careers.allLocations": "All locations",
  "careers.allTypes": "All types",
  "careers.noMatches": "Nothing open that matches. Try widening one of the three.",

...
export const es: Table = {
  ...
  "careers.rolesHeading": "Los puestos que cubrimos",
  "careers.rolesNote": "Estos son los puestos que hay. Siempre nos alegra tener noticias de alguien que valga para uno, haya o no un turno libre esta semana.",
  "careers.rolesWhere": "Todos son en nuestra tienda de {shops}.",
